...
#** Kimi-K2-Thinking-THIREUS-SMOL-SPECIAL.sh used for model   **#
#** quantization below IQ2_XXS. Adjust $1 to your needs!      **#
#**                                                           **#
#** ********************************************************* **#
#** --------------- Updated: Dec-07-2025 -------------------- **#
#** ********************************************************* **#
...
# Kimi-K2-Thinking-THIREUS-TEMPLATE.gguf is too big and not worth using it because Q8_0 quanitsation is fast!
