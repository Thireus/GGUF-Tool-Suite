...
license: mit
---
# mmproj-gemma-4-31B-it

## 🤔 What is this [HuggingFace repository](https://huggingface.co/Thireus/mmproj-gemma-4-31B-it-THIREUS-BF16-SPECIAL_SPLIT/) about?

This repository provides **GGUF-quantized tensors** for the [mmproj](https://github.com/ggml-org/llama.cpp/blob/master/docs/multimodal.md) layer(s) of the gemma-4-31B-it model (official repo: https://huggingface.co/google/gemma-4-31B-it). These GGUF shards are designed to be used with **Thireus’ GGUF Tool Suite** (https://github.com/Thireus/GGUF-Tool-Suite), a collection of tools that automatically finds the perplexity-optimal mix of quantizations for any given a model size target. With this GGUF Tool Suite, you can produce your own Dynamic 3.0 Quants recipes and achieve optimum accuracy & SOTA quantization performance. Give it a try here: https://gguf.thireus.com/quant_assign.html  
...
~/ik_llama.cpp/build/bin/llama-server \
  -m gemma-4-31B-it-THIREUS-BF16-SPECIAL_TENSOR-00001-of-*.gguf \
  --mmproj mmproj-gemma-4-31B-it-THIREUS-BF16-SPECIAL_TENSOR-00001-of-*.gguf \
...
![PPLs Compared With Others](https://github.com/Thireus/GGUF-Tool-Suite/raw/main/ppl_graphs/gemma-4-31B-it.svg)
...
```
./quantize_model.sh --model "mmproj-gemma-4-31B-it" --qtype iq2_xxs
```
