...
~/ik_llama.cpp/build/bin/llama-cli \
  -m Kimi-K2.7-Code-THIREUS-BF16-SPECIAL_TENSOR-00001-of-01148.gguf \
...
Usage example:
```
./llama-quantize --keep-split --imatrix imatrix_ubergarm.dat --individual-tensors 2,3,1094 Kimi-K2.7-Code-THIREUS-BF16-SPECIAL_TENSOR-00001-of-01097.gguf my_new_shards.gguf iq3_s 12
```
