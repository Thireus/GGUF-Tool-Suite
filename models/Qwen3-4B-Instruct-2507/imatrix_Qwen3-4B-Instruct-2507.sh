...
#** imatrix_Qwen3-4B-Instruct-2507.sh used to create the      **#
#** imatrix file.                                             **#
#**                                                           **#
#** ********************************************************* **#
#** --------------- Updated: Aug-25-2025 -------------------- **#
...
llama-imatrix \
    --verbosity 1 \
    -m ~/AI/Qwen3-4B-Instruct-2507/Qwen3-4B-Instruct-2507-THIREUS-BF16-SPECIAL_SPLIT/Qwen3-4B-Instruct-2507-THIREUS-BF16-SPECIAL_TENSOR-00001-of-00399.gguf \
