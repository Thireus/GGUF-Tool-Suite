...
#** Qwen3.5-27B-THIREUS-ANY-SPECIAL-SMOL.sh used for iq1_s*   **#
...
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.attn_gate\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59|63)\.attn_k\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59|63)\.attn_k_norm\.weight$=f32
^blk\.([0-9]|[1-5][0-9]|6[0-3])\.attn_norm\.weight$=f32
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59|63)\.attn_output\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59|63)\.attn_q\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59|63)\.attn_q_norm\.weight$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.attn_qkv\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59|63)\.attn_v\.weight$=$1

## Dense Feed-Forward Network weights — qbits: 16
^blk\.([0-9]|[1-5][0-9]|6[0-3])\.ffn_down\.weight$=$1
^blk\.([0-9]|[1-5][0-9]|6[0-3])\.ffn_up\.weight$=$1

## Gating network — qbits: 16
^blk\.([0-9]|[1-5][0-9]|6[0-3])\.ffn_gate\.weight$=$1

## Misc / Other tensors — qbits: 32 16
^blk\.([0-9]|[1-5][0-9]|6[0-3])\.post_attention_norm\.weight$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.ssm_a$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.ssm_alpha\.weight$=$1
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.ssm_beta\.weight$=$1
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.ssm_conv1d\.weight$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.ssm_dt\.bias$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.ssm_norm\.weight$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8]|6[0-2])\.ssm_out\.weight$=$1
"
...
# Qwen3.5-27B-THIREUS-TEMPLATE.gguf is too big and not worth using it because Q8_0 quanitsation is fast!
mkdir Qwen3.5-27B-THIREUS-${1^^}-SPECIAL_SPLIT/ && llama-quantize --keep-split \
    --custom-q "$custom" \
    --imatrix imatrix_ubergarm.dat \
    --ignore-imatrix-rules \
    Qwen3.5-27B-THIREUS-BF16-SPECIAL_SPLIT/Qwen3.5-27B-THIREUS-BF16-SPECIAL_TENSOR-00001-of-00852.gguf \
    Qwen3.5-27B-THIREUS-${1^^}-SPECIAL_SPLIT/Qwen3.5-27B-THIREUS-${1^^}-SPECIAL_TENSOR.gguf \
    ${1^^} \
    $(nproc) && chmod 444 Qwen3.5-27B-THIREUS-${1^^}-SPECIAL_SPLIT/*.gguf || echo "ERROR: Something went wrong, please check the directory doesn't already exist and that you have sufficient available disk space!"
