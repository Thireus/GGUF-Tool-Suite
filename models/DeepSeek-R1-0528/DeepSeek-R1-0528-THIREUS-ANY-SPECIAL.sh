...
#** DeepSeek-R1-0528-THIREUS-ANY-SPECIAL.sh used for ppl      **#
...
mkdir DeepSeek-R1-0528-THIREUS-${1^^}-SPECIAL_SPLIT/ && llama-quantize --keep-split \
    ...
    ${1^^} \
    32 && chmod 400 DeepSeek-R1-0528-THIREUS-${1^^}-SPECIAL_SPLIT/*.gguf || echo "ERROR: Something went wrong, please check the directory doesn't already exist and that you have sufficient available disk space!"
