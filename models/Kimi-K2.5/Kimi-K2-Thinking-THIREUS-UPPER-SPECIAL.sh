...
#** Kimi-K2.5-THIREUS-UPPER-SPECIAL.sh used for model         **#
...
# Alternatively, you can use bf16 tensors and replace the _exps tensors from the q4_0X quant. See Kimi-K2.5-THIREUS-UPPER2-SPECIAL.sh