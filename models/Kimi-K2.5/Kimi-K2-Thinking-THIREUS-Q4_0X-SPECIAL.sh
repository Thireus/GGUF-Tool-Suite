...
#** Kimi-K2.5-THIREUS-Q4_0X-SPECIAL.sh used with patch        **#
...
# TODO - MANUALLY - Merge the exps ggufs into a classic q4_0 (same for q4_0_r4) produced with Kimi-K2.5-THIREUS-UPPER-SPECIAL.sh and main branch
# 1. Rename the repo Kimi-K2.5-THIREUS-Q4_0X-SPECIAL_SPLIT
...
# cat Kimi-K2.5-THIREUS-BF16-SPECIAL_SPLIT/tensors.map | grep '_exps\.' | cut -d: -f1 | sed 's/\-BF16-/-Q4_0-/'
# 3. Move files to Kimi-K2.5-THIREUS-Q4_0-SPECIAL_SPLIT (classic q4_0 produced with Kimi-K2.5-THIREUS-UPPER-SPECIAL.sh):
# for f in $(cat Kimi-K2.5-THIREUS-BF16-SPECIAL_SPLIT/tensors.map | grep '_exps\.' | cut -d: -f1 | sed 's/\-BF16-/-Q4_0-/'); do mv -f Kimi-K2.5-THIREUS-Q4_0X-SPECIAL_SPLIT/$f Kimi-K2.5-THIREUS-Q4_0-SPECIAL_SPLIT/; done;
# 4. You now can safely get rid of Kimi-K2.5-THIREUS-Q4_0X-SPECIAL_SPLIT