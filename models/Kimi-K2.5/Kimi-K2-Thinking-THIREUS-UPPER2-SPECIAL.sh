...
#** Kimi-K2.5-THIREUS-UPPER2-SPECIAL.sh used for model **#
...
# Kimi-K2.5-THIREUS-TEMPLATE.gguf is too big and not worth using it because Q8_0 quanitsation is fast!
...
# TODO - Manually: replace the _exps tensors from the q4_0X quant produced with Kimi-K2.5-THIREUS-Q4_0X-SPECIAL.sh (see bottom notes of that script)