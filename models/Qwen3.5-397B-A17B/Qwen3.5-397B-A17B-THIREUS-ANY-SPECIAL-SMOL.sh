...
#** Qwen3.5-397B-A17B-THIREUS-ANY-SPECIAL-SMOL.sh used for    **#
...
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.attn_gate\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59)\.attn_k\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59)\.attn_k_norm\.weight$=f32
^blk\.([0-9]|[1-5][0-9])\.attn_norm\.weight$=f32
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59)\.attn_output\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59)\.attn_q\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59)\.attn_q_norm\.weight$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.attn_qkv\.weight$=$1
^blk\.(3|7|11|15|19|23|27|31|35|39|43|47|51|55|59)\.attn_v\.weight$=$1

## MoE Gating & Routing — qbits: 32
^blk\.([0-9]|[1-5][0-9])\.ffn_gate_inp\.weight$=f32

## Misc / Other tensors — qbits: 32 16
^blk\.([0-9]|[1-5][0-9])\.post_attention_norm\.weight$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.ssm_a$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.ssm_alpha\.weight$=$1
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.ssm_beta\.weight$=$1
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.ssm_conv1d\.weight$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.ssm_dt\.bias$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.ssm_norm\.weight$=f32
^blk\.([0-2]|[4-6]|[8-9]|10|1[2-4]|1[6-8]|2[0-2]|2[4-6]|2[8-9]|30|3[2-4]|3[6-8]|4[0-2]|4[4-6]|4[8-9]|50|5[2-4]|5[6-8])\.ssm_out\.weight$=$1

## GPU-loaded - MoE Shared Experts Feed-Forward Network - ffn_*_shexp
# ffn_down_shexp — down-projection (shared experts) — qbits: 16
^blk\.([0-9]|[1-5][0-9])\.ffn_down_shexp\.weight$=$1

# ffn_up_shexp — up-projection (shared experts) — qbits: 16
^blk\.([0-9]|[1-5][0-9])\.ffn_up_shexp\.weight$=$1

# ffn_gate_shexp — gating network (shared experts) — qbits: 32 16
^blk\.([0-9]|[1-5][0-9])\.ffn_gate_inp_shexp\.weight$=f32
^blk\.([0-9]|[1-5][0-9])\.ffn_gate_shexp\.weight$=$1

## CPU-friendly - MoE Per-expert Feed-Forward Network - ffn_*_exps
# ffn_down_exps — down-projection (per-expert) — qbits: 16
^blk\.([0-9]|[1-5][0-9])\.ffn_down_exps\.weight$=$1

# ffn_up_exps — up-projection (per-expert) — qbits: 16
^blk\.([0-9]|[1-5][0-9])\.ffn_up_exps\.weight$=$1

# ffn_gate_exps — gating network (per-expert) — qbits: 16
^blk\.([0-9]|[1-5][0-9])\.ffn_gate_exps\.weight$=$1
"
...
# Qwen3.5-397B-A17B-THIREUS-TEMPLATE.gguf is too big and not worth using it because Q8_0 quanitsation is fast!
mkdir Qwen3.5-397B-A17B-THIREUS-${1^^}-SPECIAL_SPLIT/ && llama-quantize --keep-split \
    --custom-q "$custom" \
