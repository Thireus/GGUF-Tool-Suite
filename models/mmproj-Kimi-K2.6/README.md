...
~/ik_llama.cpp/build/bin/llama-cli \
  ...
  --mmproj mmproj-Kimi-K2.6-THIREUS-BF16-SPECIAL_TENSOR-00001-of-*.gguf \
...
Usage example:
```
./llama-quantize --keep-split --imatrix imatrix_ubergarm.dat --individual-tensors 2,3,1094 mmproj-Kimi-K2.6-THIREUS-BF16-SPECIAL_TENSOR-00001-of-01097.gguf my_new_shards.gguf iq3_s 12
```
