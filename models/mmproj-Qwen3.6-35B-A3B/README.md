...
license: mit
---
# mmproj-Qwen3.6-35B-A3B

## 🤔 What is this [HuggingFace repository](https://huggingface.co/Thireus/mmproj-Qwen3.6-35B-A3B-THIREUS-BF16-SPECIAL_SPLIT/) about?

This repository provides **GGUF-quantized tensors** for the [mmproj](https://github.com/ggml-org/llama.cpp/blob/master/docs/multimodal.md) layer(s) of the Qwen3.6-35B-A3B model (official repo: https://huggingface.co/Qwen/Qwen3.6-35B-A3B). These GGUF shards are designed to be used with **Thireus’ GGUF Tool Suite** (https://github.com/Thireus/GGUF-Tool-Suite), a collection of tools that automatically finds the perplexity-optimal mix of quantizations for any given a model size target. With this GGUF Tool Suite, you can produce your own Dynamic 3.0 Quants recipes and achieve optimum accuracy & SOTA quantization performance. Give it a try here: https://gguf.thireus.com/quant_assign.html  
...
cp -f models/Qwen3.6-35B-A3B/download.conf . # Use the download.conf of the chosen model
mkdir -p kitchen && cd kitchen
# Obtain a recipe example for the chosen model from ../recipe_examples/
../quant_downloader.sh ../recipe_examples/ik_llama.cpp_recipes/Qwen3.6-35B-A3B.ROOT-3.5993bpw-11.3565ppl.1GB-GGUF_0GB-GPU_0GB-CPU.9888e4b_831ff04.recipe
...
~/ik_llama.cpp/build/bin/llama-server \
  -m Qwen3.6-35B-A3B-THIREUS-BF16-SPECIAL_TENSOR-00001-of-*.gguf \
  --mmproj mmproj-Qwen3.6-35B-A3B-THIREUS-BF16-SPECIAL_TENSOR-00001-of-*.gguf \
...
Here’s how Qwen3.6-35B-A3B quantized with **Thireus’ GGUF Tool Suite** stacks up against other quantizers (lower perplexity = better at equal or lower bpw):

![PPLs Compared With Others](https://github.com/Thireus/GGUF-Tool-Suite/raw/main/ppl_graphs/Qwen3.6-35B-A3B.svg)
