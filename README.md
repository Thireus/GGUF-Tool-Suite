...
*All PPL benchmarks are computed with the parameters `-ctk f16 -c 512 -b 4096 -ub 4096`, except for Qwen3.5 which are set to `-b 512 -ub 512`. Changing any of these parameters will alter the PPL. In particular, reducing `-b 4096 -ub 4096` increases the PPL, while increasing them decreases the PPL.*
...
| [Kimi-K2-Thinking](https://huggingface.co/collections/Thireus/kimi-k2-thinking-thireus-special-split) |🅲✅ Complete<br>🆀✅ Complete<br>🅶⚠️ Untested<br>🅴⚠️ Not evaluated | https://github.com/Thireus/GGUF-Tool-Suite/issues/39, Q4_0* and Q4_K* _exps tensors are optimised with the patches provided by @jukofyork on https://github.com/ggml-org/llama.cpp/pull/17064. Group0 calibration data still in progress, and will be using `-b 512 -ub 512 -amb 512` due to hardware limitations... |
...
| [GLM-4.7-Flash](https://huggingface.co/collections/Thireus/glm-47-thireus-special-split) |🅲✅ Complete<br>🆀✅ Complete<br>🅶⚠️ Untested<br>🅴⚠️ Not evaluated | Important: do not use ppl_results.csv for this model, instead use the kld_results.csv calibrated data file. See: https://github.com/Thireus/GGUF-Tool-Suite/issues/52 |
| [GLM-4.7](https://huggingface.co/collections/Thireus/glm-47-thireus-special-split) |🅲✅ Complete<br>🆀✅ Complete<br>🅶✅ Tested and Working<br>🅴✅ Yes | Similar to GLM-4.6. |
