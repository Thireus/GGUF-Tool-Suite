...
| [DeepSeek-V3-0324](https://huggingface.co/collections/Thireus/deepseek-v3-0324-thireus-special-split-6885d5fba52645afa377cc79) | ⚠️ [Work in progress...](https://github.com/Thireus/GGUF-Tool-Suite/issues/12) | ⚠️ Work in progress... | ⚠️ Untested | ⚠️ Not evaluated | Should not be any different than DeepSeek-R1-0528. |
...
| [GLM-4.5](https://huggingface.co/collections/Thireus/glm-45-thireus-special-split-6888e23853f18dd2d57a295b) | ⚠️ Work in progress... | ⚠️ Almost completed | ⚠️ Untested | ⚠️ Evaluation in progress... | GGUF format has changed as per last llama.cpp/ik_llama.cpp PR. Shards and calibration data needs to be redone. Support in `llama.cpp` is currently broken – see the discussion in [PR #14939](https://github.com/ggml-org/llama.cpp/pull/14939). Support in `ik_llama.cpp` is working but experimental, refer to [ikawrakow/ik_llama.cpp#668](https://github.com/ikawrakow/ik_llama.cpp/pull/668) |
| [GLM-4.5-Air](https://huggingface.co/collections/Thireus/glm-45-air-thireus-special-split-688f9936d839ef353d92426a) | ✅ Complete | ⚠️ Almost completed | ✅ Tested and Working | ✅ Tested and Working | Supported in `llama.cpp` – see the discussion in [PR #14939](https://github.com/ggml-org/llama.cpp/pull/14939). Support in `ik_llama.cpp` is working but PR not merged yet, refer to [ikawrakow/ik_llama.cpp#668](https://github.com/ikawrakow/ik_llama.cpp/pull/668) |
