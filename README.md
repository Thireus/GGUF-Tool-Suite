...
| [DeepSeek-V3.2-Exp](https://huggingface.co/collections/Thireus/deepseek-v32-exp-thireus-special-split) |🅲⚠️ Not Started<br>🆀⚠️ Not Started<br>🅶⚠️ Untested<br>🅴⚠️ Not evaluated | Similar to DeepSeek-V3.1-Terminus |
| [DeepSeek-V3.2](https://huggingface.co/collections/Thireus/deepseek-v32-thireus-special-split) |🅲⚠️ Not Started<br>🆀⚠️ Not Started<br>🅶⚠️ Untested<br>🅴⚠️ Not evaluated | Similar to DeepSeek-V3.1-Terminus |
...
| [Kimi-K2-Thinking](https://huggingface.co/collections/Thireus/kimi-k2-thinking-thireus-special-split) |🅲⚠️ Not Started<br>🆀✅ Complete<br>🅶⚠️ Untested<br>🅴⚠️ Not evaluated | https://github.com/Thireus/GGUF-Tool-Suite/issues/39, Q4_0* and Q4_K* _exps tensors are optimised with the patches provided by @jukofyork on https://github.com/ggml-org/llama.cpp/pull/17064 |
