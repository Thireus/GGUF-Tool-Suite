...
| [GLM-4.5-Air](https://huggingface.co/collections/Thireus/glm-45-air-thireus-special-split-688f9936d839ef353d92426a) | ✅ Complete | ⚠️ Almost completed | ✅ Tested and Working | ✅ Tested and Working | You must use the latest version of `llama.cpp`/`ik_llama.cpp`. Support in `llama.cpp` – see the discussion in [PR #14939](https://github.com/ggml-org/llama.cpp/pull/14939). Support in `ik_llama.cpp` – see the discussion in [ikawrakow/ik_llama.cpp#668](https://github.com/ikawrakow/ik_llama.cpp/pull/668) |
