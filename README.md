...
| [GLM-4.5](https://huggingface.co/collections/Thireus/glm-45-thireus-special-split-6888e23853f18dd2d57a295b) | ⚠️ Partial calibration data provided | ⚠️ Work in progress... | ⚠️ Untested | ⚠️ Not evaluated | Support in `llama.cpp` is currently broken – see the discussion in [PR #14939](https://github.com/ggml-org/llama.cpp/pull/14939). Support in `ik_llama.cpp` is working but experimental, refer to [ikawrakow/ik_llama.cpp#668](https://github.com/ikawrakow/ik_llama.cpp/pull/668) |
| [GLM-4.5-Air](https://huggingface.co/collections/Thireus/glm-45-air-thireus-special-split-688f9936d839ef353d92426a) | ❌ Not started | ⚠️ Work in progress... | ⚠️ Untested | ⚠️ Not evaluated | Support in `llama.cpp` is currently broken – see the discussion in [PR #14939](https://github.com/ggml-org/llama.cpp/pull/14939). Support in `ik_llama.cpp` is working but experimental, refer to [ikawrakow/ik_llama.cpp#668](https://github.com/ikawrakow/ik_llama.cpp/pull/668) |
